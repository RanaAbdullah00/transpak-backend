...
/** Total attempts = 1 + UPLOAD_MAX_RETRIES (default: one retry on failure). */
const UPLOAD_MAX_RETRIES = Math.min(3, Math.max(0, Number(process.env.UPLOAD_MAX_RETRIES ?? 1)));
